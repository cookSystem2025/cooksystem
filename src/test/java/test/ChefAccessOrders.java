...
public class ChefAccessOrders {
    ...
    public void the_customer_has_these_past_orders(String customerName, DataTable dataTable) {
        ...
        for (Map<String, String> row : orders) {
            ...
            String date = "2025-04-25"; // Default date since it's not given
        ...
        System.out.println("Saved past orders for customer: " + customerName);
    }
    ...
    public void the_chef_opens_the_profile_of(String customerName) {
        ...
        System.out.println("Chef opened profile of: " + customerName);
    }
    ...
    public void the_system_should_show_the_customer_s_past_orders() {
        ...
        System.out.println("Past Orders for " + selectedCustomer.getCustomerName() + ":");
    ...
    public void the_chef_should_suggest_a_meal_plan_based_on_the_past_meals() {
        ...
        System.out.println("Chef suggests: A new meal inspired by '" + suggestedOrder.getMealName() + "'");
    }
}
